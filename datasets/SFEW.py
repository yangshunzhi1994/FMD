...
class SFEW(data.Dataset):
    ...
    def __init__(self, split='Training', transform=None, student_norm=None, teacher_norm=None):
        ...
        self.split = split
        self.data = h5py.File('datasets/SFEW_data_100.h5', 'r', driver='core')
        ...
        if self.split == 'Training':
            ...
            self.train_data = self.train_data.reshape((958, 100, 100, 3))
            ...
            self.PrivateTest_data = self.PrivateTest_data.reshape((436, 100, 100, 3))
...
class SFEW_teacher(data.Dataset):
    """`FER2013 Dataset.
...
class SFEW_student(data.Dataset):
    """`FER2013 Dataset.
